import 'package:mendez/pages/project.dart';
    ...
    return Scaffold(
      ...
      body: Column(children: [
        ...
        Container(
          ...
          height: 170,
          decoration: BoxDecoration(color: Color(0xff700404)),
          child:
        ...
        Padding(
          ...
          child: Row(
            children: [
              buildFileSizeChart("FUENTE", Colors.blue, .3),
              const SizedBox(
                width: 2,
              ),
              ...
              buildFileSizeChart("IMAGENES", Colors.yellow, .20),
              const SizedBox(
                width: 2,
              ),
        ...
        Expanded(
          child: ListView(
            ...
            children: [
              ...
              Row(
                children: [
                  buildFileColumn('sketch', 'escritorio', '.sketch'),
                  SizedBox(
                    width: availableScreenWidth * .03,
                  ),
                  buildFileColumn('sketch', 'movil', '.sketch'),
                  SizedBox(
                    width: availableScreenWidth * .03,
                  ),
                  buildFileColumn('prd', 'interaccion', '.prd'),
                ],
              ),
              const Divider(
                height: 60,
              ...
              // Folder List
              buildProjectRow("Chat"),
              buildProjectRow("Nota de Tiempo"),
              buildProjectRow("Algo"),
              buildProjectRow("Otro"),
            ],
          ),
        )
      ]),
